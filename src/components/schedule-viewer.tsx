        ...
        <section className="relative mx-auto flex w-full max-w-7xl flex-col gap-6 px-4 py-5 sm:px-6 lg:px-8 lg:py-8">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-300">
                  Shared calendar preview with formatted blocked dates.
                </p>
              </div>
            </div>
          ...
          <section className="grid gap-6 xl:grid-cols-[1.08fr_0.92fr]">
            <article className="rounded-4xl border border-white/10 bg-white/8 p-5 shadow-2xl shadow-black/25 backdrop-blur sm:p-6">
              <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
                <div className="max-w-2xl">
                  ...
                  <p className="mt-3 text-sm leading-6 text-slate-300 sm:text-base">
                    This page is intentionally read-only. It shows the calendar,
                    the date ranges, and a clean date summary without the
              ...
              <div className="mt-6 rounded-[1.75rem] border border-white/10 bg-slate-950/40 p-3 shadow-inner shadow-black/20 sm:p-4">
                <DayPicker
                  mode="multiple"
            ...
            <aside className="rounded-4xl border border-white/10 bg-white/8 p-5 shadow-2xl shadow-black/25 backdrop-blur sm:p-6">
              ...
              {sortedRanges.length === 0 ? (
                <div className="rounded-3xl border border-dashed border-white/15 bg-white/5 p-6 text-sm leading-6 text-slate-300">
